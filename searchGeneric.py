...
class AStarSearcher(Searcher):
    ...
    def __init__(self, problem):
        ...
        self.problem.heuristic = self.problem.heuristic1
...
''')
    ...
    board0 = bloxorz.Board.read_board(fake_file)
    bp0 = BloxorzProblem(board0)
    bp0.heuristic = bp0.heuristic1
    # test(Searcher, bp0)  # DFS doesn't work since it isn't the shortest path, got a->b->d->g
    test(AStarSearcher, bp0)
    test(AStarMultiPruneSearcher, bp0)
